...
exports.Formats = [
  ...
  mod: 'gen7',
	...
	},
	{
		...
		{
		name: "[Gen 7] Unreleased",
		desc: [
			"All Unreleased and Illegal mons allowed."
		],

		mod: 'gen7',
		ruleset: ['Pokemon', 'Endless Battle Clause', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod', 'Mega Rayquaza Clause'],
		banlist: [],
	},
	{
		name: "[Gen 7] CAP",
...
ruleset: ['[Gen 7] Ubers'], 		
banList: ["Eviolite"],
desc: ['<a href="http://www.smogon.com/forums/threads/3610073/">Tier Shift</a>: Pokemon get a +10 boost to each stat per tier below OU they are in. UU gets +10, RU +20, NU +30, PU +40 and LC +50.'], 		
mod: 'gen7', 		
onModifyTemplate: function (template, pokemon) { 			
  if (pokemon.tierShifted) return template; 			
  let tierShift = Object.assign({}, template); 			
  const boosts = { 			'UU': 10, 				'BL2': 10, 				'RU': 20, 				'BL3': 20, 				'NU': 30, 				'BL4': 30, 				'PU': 40, 				'NFE': 40, 				'LC Uber': 50, 				'LC': 50, 			}; 			
  ...
  tierShift.baseStats[statName] = 
this.clampIntRange(template.baseStats[statName] + boost, 1, 255); 			
} 			
...
/*{
  ...
  mod: 'gen7',
  team: 'random',
  ruleset: ['PotD', 'Pokemon', 'Sleep Clause Mod', 'HP Percentage Mod', 'Cancel Mod', 'Alola Pokedex']
},
{
  name: "[Gen 7] Sinnoh Random",
  desc: ["Random of Sinnoh Pokemon."],
  
  mod: "gen7",
  team: "random",
  ruleset: ["PotD", "Pokemon", "Sleep Clause Mod", "HP Percentage Mod", "Cancel Mod", "Sinnoh Pokedex"]
},
{
  name: "[Gen 7] Hoenn Random",
  desc: ["Random of Hoenn Pokémon."],

  mod: 'gen7',
  team: 'random',
  ruleset: ['PotD', 'Pokemon', 'Sleep Clause Mod', 'HP Percentage Mod', 'Cancel Mod', 'Hoenn Pokedex']
},
{
  name: "[Gen 7] LC Random",
  desc: ["Random of LC Pokémon."],
  ...
  banlist: []
	...
	{
		name: "[Gen 1] Nostalgic Tournament",

		mod: 'gen1',
		ruleset: ['Pokemon', 'Standard'],
		banlist: ['Mewtwo', 'Sleep Powder', 'Lovely Kiss', 'Hypnosis'],
	},
  {
    name: "[Gen 7] Random Tournament",
  
    mod: "gen7",
    team: "random",
    ruleset: ["PotD", "Pokemon", "Sleep Clause Mod", "Exact HP Mod", "Cancel Mod", "Team Preview", "Freeze Clause Mod", "Mega Rayquaza Clause"],
  },
